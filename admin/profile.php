...
<title>Profil Admin - SIKOPAT</title>
...
<div class="sidebar">
    ...
    <ul>
        ...
        <li><a href="profil.php" class="active"><i class="fa-solid fa-user"></i> Profil Admin</a></li>
...
<div class="content">
    <div class="top-bar">
        <h1><i class="fa-solid fa-user"></i> Profil Admin</h1>
        <p>Detail akun admin yang sedang login</p>
    </div>

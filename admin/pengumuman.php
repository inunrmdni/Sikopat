                    ...
                    <td>
                        <div class="action-buttons">
                            <button class="btn btn-info btn-sm" 
                                    onclick='lihatDetail(<?= json_encode($row) ?>)'>
...
function lihatDetail(data) {
    ...
    Swal.fire({
        title: '<i class="fa-solid fa-bullhorn"></i> Detail Pengumuman',
        html: `
            <div style="text-align: left;">
                <div class="detail-item">
                    <div class="detail-label">
                        <i class="fa-solid fa-hashtag"></i> ID Pengumuman
                    </div>
                ...
                <div class="detail-item">
                    <div class="detail-label">
                        <i class="fa-solid fa-bookmark"></i> Judul
                    </div>
                ...
                <div class="detail-item">
                    <div class="detail-label">
                        <i class="fa-solid fa-align-left"></i> Isi Pengumuman
                    </div>
                    <div class="detail-value" style="white-space: pre-wrap;">${data.isi}</div>
                </div>
                
                <div class="detail-item">
                    <div class="detail-label">
                        <i class="fa-solid fa-calendar-plus"></i> Tanggal Dibuat
                    </div>
                    <div class="detail-value">${tanggalFormat}</div>
                </div>
            </div>
        `,
        width: '600px',
